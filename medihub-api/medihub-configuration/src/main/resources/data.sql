...
insert into predefined_appointment (doctor_id, start_time, price, clinic_room_id, appointment_type_id, discount, duration) values (1, '2020-06-24 10', 1800.0, 2, 1, 0.2, 1.0);
insert into medical_doctor_predefined_appointment_schedule_item (id, doctor_id, start_time, schedule_item_type, predefined_appointment_id) values (999099, 10, '2020-06-24 10', 5, 1);
insert into clinic_room_schedule_item (clinic_room_id, start_time) values (2, '2020-06-24 10');
insert into predefined_appointment (doctor_id, start_time, price, clinic_room_id, appointment_type_id, discount, duration) values (2, '2020-06-28 15', 1100.0, 3, 1, 0.2, 1.0);
insert into medical_doctor_predefined_appointment_schedule_item (id, doctor_id, start_time, schedule_item_type, predefined_appointment_id) values (999098, 17, '2020-06-28 15', 5, 2);
insert into clinic_room_schedule_item (clinic_room_id, start_time) values (3, '2020-06-28 15');
insert into predefined_appointment (doctor_id, start_time, price, clinic_room_id, appointment_type_id, discount, duration) values (1, '2020-06-28 06', 600.0, 3, 1, 0.5, 1.0);
...
insert into predefined_appointment (doctor_id, start_time, price, clinic_room_id, appointment_type_id, discount, duration) values (3, '2020-06-20 03', 900.0, 1, 1, 0.2, 1.0);
insert into medical_doctor_predefined_appointment_schedule_item (id, doctor_id, start_time, schedule_item_type, predefined_appointment_id) values (999096, 3, '2020-06-20 03', 5, 4);
insert into clinic_room_schedule_item (clinic_room_id, start_time) values (1, '2020-06-20 03');
insert into predefined_appointment (doctor_id, start_time, price, clinic_room_id, appointment_type_id, discount, duration) values (2, '2020-06-28 18', 800.0, 2, 1, 0.1, 1.0);
...
insert into predefined_appointment (doctor_id, start_time, price, clinic_room_id, appointment_type_id, discount, duration) values (4, '2020-06-20 05', 1900.0, 4, 1, 0.0, 1.0);
insert into medical_doctor_predefined_appointment_schedule_item (id, doctor_id, start_time, schedule_item_type, predefined_appointment_id) values (999094, 18, '2020-06-20 05', 5, 6);
insert into clinic_room_schedule_item (clinic_room_id, start_time) values (4, '2020-06-20 05');
