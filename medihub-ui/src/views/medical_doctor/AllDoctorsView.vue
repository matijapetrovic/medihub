...
export default {
  data: () => ({
    ...
    headers: [
      ...
      { text: 'Address', value: 'clinic.address.addressLine' },
      { text: 'Telephone', value: 'account.telephoneNumber' },
      { text: 'Start of work', value: 'workingTime.from[0]' },
      { text: 'End of work', value: 'workingTime.to[0]' },
